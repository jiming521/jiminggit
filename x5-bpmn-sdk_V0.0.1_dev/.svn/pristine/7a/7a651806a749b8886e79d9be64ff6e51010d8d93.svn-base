...
import com.casic.task.TaskClientForCas;
 ...
 * @Description:  流程任务测试
 */
public class TaskClientTestForCas {
	...
	public TaskClientTestForCas(){
		TaskClientForCas.getTaskClientForCas().login(username, password);
	}
	...
	public void getTaskByTaskId(){
		...
		String taskByTaskId = TaskClientForCas.getTaskClientForCas().getTaskByTaskId(params);
	...
	public void getTasksByInstId(){
		...
		String getTasksByInstId = TaskClientForCas.getTaskClientForCas().getTasksByInstId(params);
	...
	public void getTodoList(){
		...
		String getTodoList = TaskClientForCas.getTaskClientForCas().getTodoList(params);
