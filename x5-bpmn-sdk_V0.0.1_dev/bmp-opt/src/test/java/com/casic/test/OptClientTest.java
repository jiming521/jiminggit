...
import com.casic.opt.OptClient;
 ...
 * @Description:  流程操作测试
 */
public class OptClientTest {
	
	private static OptClient client = new OptClient();
	...
	public void startProcess(){
		...
		params.put("defId", "10000004000001");
		String startProcess = client.startProcess(params);
	...
	public void doNext(){
		...
		params.put("taskId", "10000004090059");
		String doNext = client.doNext(params);
	...
	public void doEndProcess(){
		...
		params.put("taskId", "10000004090123");
	...
	public void getHistoryOpinion(){
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("instanId", "10000004010008");
